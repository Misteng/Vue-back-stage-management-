	...
	<div class="demo-input-size">
		...
		<el-table class="list"
			...
			<template slot-scope="scope">
				<el-button
					size="mini"
					@click="readin(scope.$index,scope.row),changeFormVisible=true"><i class="el-icon-edit"></i></el-button>
					...
					<!-- 				<el-form-item label="商品信息不能为空,请输入商品信息" :label-width="LabelWidth" class="red">
								...
								<div slot="footer" class="dialog-footer">
									...
									<el-button type="primary" @click="handleEdit(),changeFormVisible = false">确 定</el-button>
								</div>
							</el-dialog>
